...
jQuery(document).ready(function(){
	...
	jQuery('body').append('<div id="style-switcher"><div class="swtch-opener"><span class="glyphicon glyphicon-cog"></span></div><div class="swtch-header"><h3>STYLE SWITCHER</h3></div><div class="styleswtch"></div>');
	
	demo_panel = jQuery('body').find('.styleswtch');
	
	
	//Colors Panel
	demo_panel.append('<ul class="ul-colors clearfix"><h5>COLORS</h5><li id="color1"></li><li id="color2"></li><li id="color3"></li><li id="color4"></li><li id="color5"></li><li id="color6"></li></ul>');
